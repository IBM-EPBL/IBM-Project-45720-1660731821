...
#define ORG "g4apja"//IBM ORGANITION ID
#define DEVICE_TYPE "r3ibm"//Device type mentioned in ibm watson IOT Platform
#define DEVICE_ID "r123"//Device ID mentioned in ibm watson IOT Platform
